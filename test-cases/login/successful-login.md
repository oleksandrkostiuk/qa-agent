...
Expected Result: User is redirected to /secure, a success flash message "You logged into a secure area!" is displayed, and the Logout button is visible.
Linked Requirement: None

---
ID: TC-LOGIN-SUCCESS-002
Title: Authenticated session persists on direct navigation to /secure
Type: UI
Feature: login
Flow: successful-login
Priority: High
...
Test Data: None
Steps:
  1. While logged in, navigate away from /secure (e.g. to /login)
  2. Navigate directly to /secure via the URL bar
Expected Result: The /secure page loads directly without redirecting to /login; the user remains authenticated and the secure area content is shown.
Linked Requirement: None
